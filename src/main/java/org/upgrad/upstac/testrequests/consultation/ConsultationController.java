...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        List<TestRequest> testRequest = testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED);
        ...
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"No Test request found");
        }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"No test request available");
        }
